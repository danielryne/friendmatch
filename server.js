...
var friends = [
  ...
  {
    name: "Frodo Baggins",
    photo: "https://seekinggoddailyblog.files.wordpress.com/2016/07/1b9384b6de87ab45a1391d454bd695c5.jpg",
    scores: [3,3,3,3,3,3,3,3,3,3]
  },
  {
    name: "Legolas",
    photo: "https://i.pinimg.com/736x/04/80/29/048029f362c484a2a46b928afbe98837--orlando-bloom-legolas-eye-candy.jpg",
...
app.post("/api/friends", function(req, res) {
  ...
  for (i = 0; i < friends.length; i++){
    ...
    for (j = 0; j < 10; j++) {
      ...
      console.log(friends[i].name + " " + matchValue);
